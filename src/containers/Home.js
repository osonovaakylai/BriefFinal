        ...
        return(
            <div>
                    ...
                    <div className="uk-container uk-container-expand">
                        ...
                        <div className="uk-navbar-left">
                            <ul className="uk-navbar-nav">
                                <li className="first"><a href="index.html"> <img src={logo} alt=""/></a></li>
                            </ul>
                        </div>
                ...
                <div className="uk-container uk-container-smaller">
                    ...
                    <div>
                        <div className="uk-card">
                        <div className="img_style img"><img src={docker} alt="" className="img_style"/></div>
                        </div>
                    </div>
                    <div>
                        <div className="uk-card">
                        <div className="img_style img"><img src={max} alt="" className="img_style"/></div>
                        </div>
                    </div>
                    </Grid>
                </div>
